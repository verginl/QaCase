...
**Expected Result:** Sistem menemukan tenant, kemudian layar login Microsoft muncul.
**Prioritas:** High

**TC-SI-02 – Username tidak terdaftar (Negative)**
**Step:** Input username tidak valid
**Expected Result:** Muncul pesan “User not found”.
**Prioritas:** High
...
**TC-SI-08 – Batas percobaan password (Negative)**
**Step:**
